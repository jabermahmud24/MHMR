...
class Frame:
    ...
    #get d values of the frame
    @property
    def get_element_3_4(self):
        return self.t_4_4[2][3]
    ...
    def from_dh(dh_params):
        ...
        transformation_matrix= np.array([[c(theta), -s(theta) * c(alpha), s(theta) * s(alpha), a * c(theta)],
